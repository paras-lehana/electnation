...
| **T**ampering | `/api/forward/analysis` payload | Zod schema + 4 KB body cap + reCAPTCHA Enterprise |
...
- Gemini safety settings: 4 `HARM_CATEGORY_*` at `BLOCK_MEDIUM_AND_ABOVE`.
