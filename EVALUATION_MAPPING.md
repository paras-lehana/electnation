...
| **Testing** | Vitest unit + Supertest integration now implemented; service-level Forward Clinic tests added; component/e2e queued | `pnpm --filter @yatra/functions test`, direct web/functions `tsc --noEmit`; full build queued after code-quality slice | `TESTING.md` |
